...
int onig_new_default(OnigRegex *regex, const OnigUChar *pattern, const OnigUChar *pattern_end, OnigOptionType option, OnigErrorInfo *einfo)
{
    return onig_new(regex, pattern, pattern_end, option, ONIG_ENCODING_UTF8, ONIG_SYNTAX_DEFAULT, einfo);
}
